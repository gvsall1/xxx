...
public class CacheConfiguration {
        ...
        log.info("Defining Infinispan Global Configuration");
            if (this.registration == null) { // if registry is not defined, use native discovery
                ...
                return () -> GlobalConfigurationBuilder
                    ...
                    .clusterName("infinispan-order-cluster").globalJmxStatistics()
    ...
    class InfinispanJCacheManager extends JCacheManager {
        ...
        public InfinispanJCacheManager(URI uri, EmbeddedCacheManager cacheManager, CachingProvider provider,
            ...
            registerPredefinedCache(com.exc.domain.CryptoCurrency.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.exc.domain.CryptoCurrency.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.exc.domain.CurrencyFee.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.exc.domain.CurrencyFee.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.exc.domain.OrderPairFee.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.exc.domain.OrderPairFee.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
         /*   registerPredefinedCache(com.exc.domain.OrderPair.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.exc.domain.OrderPair.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.exc.domain.OrderPair.class.getName() + ".executions", new JCache<Object, Object>(
                cacheManager.getCache(com.exc.domain.OrderPair.class.getName() + ".executions").getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.exc.domain.UserInfo.class.getName(), new JCache<Object, Object>(
                ...
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.exc.domain.UserInfo.class.getName() + ".orders", new JCache<Object, Object>(
                cacheManager.getCache(com.exc.domain.UserInfo.class.getName() + ".orders").getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.exc.domain.UserInfo.class.getName() + ".operations", new JCache<Object, Object>(
                cacheManager.getCache(com.exc.domain.UserInfo.class.getName() + ".operations").getAdvancedCache(), this,
                ConfigurationAdapter.create()));*/
            registerPredefinedCache(com.exc.domain.CurrencyPair.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.exc.domain.CurrencyPair.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
