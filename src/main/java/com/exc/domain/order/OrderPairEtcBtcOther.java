...
@Entity
@Table(name = "order_pair_etc_btc_other")
@ApiModel(description = "btc - etc other order type implementation")
@AssociationOverride(name = "executions", joinTable = @JoinTable(name = "order_pair_etc_btc_other_exec",
...
public class OrderPairEtcBtcOther extends OrderPair<OrderPairEtcBtcOther> {
    @Id
