...
@Entity
@Table(name = "order_pair_eth_btc_open")
@ApiModel(description = "btc - eth open order implementation")
@AssociationOverride(name = "executions", joinTable = @JoinTable(name = "order_pair_eth_btc_open_exec",
...
public class OrderPairEthBtcOpen extends OrderPair<OrderPairEthBtcOpen> {
    @Id
